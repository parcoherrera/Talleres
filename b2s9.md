...
object Problema1 extends App {
  ...
  sensor1.zipWith(sensor2) { (temp1, temp2) =>
    val difAbs = temp2 - temp1
    println(f"Sensor1: $temp1%.2f°C, Sensor2: $temp2%.2f°C, Diferencia: $difAbs%.2f°C")
    if ((difAbs) > 5) println(f"🚨 ALERTA! Diferencia significativa detectada: $difAbs%.2f°C")
  }.take(10).subscribe()
